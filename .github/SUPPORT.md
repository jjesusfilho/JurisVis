# Getting help with JurisVis

Thanks for using JurisVis. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/JurisVis/issues) to make sure the 
